...
그래서 7팀은 '이번 과제의 신규 기능 개발 건'에 대한 E2E 테스트(드래그앤드랍)와 통합테스트(클릭 시 이벤트폼) 보강하는 전략을 세웠다.

## 심화과제 결과물

- **E2E** : playwright/test/DND/drag-drop-workflow.spec.ts
- **통합** :   
src/__tests__/integration/MonthView.EventForm.integration.spec.tsx
  src/__tests__/integration/WeekView.EventForm.integration.spec.tsx
---
