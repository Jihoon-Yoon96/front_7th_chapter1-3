...
const IntegrationTestWrapper = ({ initialFormState = {} }) => {
  ...
  return (
    <div>
      <WeekView
        currentDate={new Date('2025-11-03')} // Monday
...
describe('WeekView와 EventForm 통합 테스트', () => {
  it('WeekView의 이벤트를 클릭하면 EventForm에 해당 데이터가 채워져야 한다', () => {
  ...
  it('기존에 EventForm에 값이 있었어도, WeekView의 이벤트를 클릭하면 데이터가 변경된다', () => {
    const initialData = {
      title: '초기 제목',
      date: '2025-01-01',
      description: '초기 설명',
